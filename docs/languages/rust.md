...
| 9 | [oven-sh/bun](https://github.com/oven-sh/bun)<br><sub>Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one</sub> | 96,017 | 5,056 | Rust |
...
| 19 | [warpdotdev/warp](https://github.com/warpdotdev/warp)<br><sub>Warp is an agentic development environment, born out of the terminal.</sub> | 65,137 | 5,581 | Rust |
| 20 | [rust-lang/rustlings](https://github.com/rust-lang/rustlings)<br><sub>:crab: Small exercises to get you used to reading and writing Rust code!</sub> | 64,200 | 11,251 | Rust |
| 21 | [tw93/Pake](https://github.com/tw93/Pake)<br><sub>🤱🏻 Turn any webpage into a desktop app with one command.</sub> | 61,669 | 12,705 | Rust |
...
| 29 | [aaif-goose/goose](https://github.com/aaif-goose/goose)<br><sub>an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM</sub> | 54,589 | 6,300 | Rust |
| 30 | [lencx/ChatGPT](https://github.com/lencx/ChatGPT)<br><sub>❄️ ChatGPT Desktop Application (Mac, Windows and Linux)</sub> | 54,561 | 6,152 | Rust |
| 31 | [astral-sh/ruff](https://github.com/astral-sh/ruff)<br><sub>An extremely fast Python linter and code formatter, written in Rust.</sub> | 49,741 | 2,432 | Rust |
| 32 | [bevyengine/bevy](https://github.com/bevyengine/bevy)<br><sub>A refreshingly simple data-driven game engine built in Rust</sub> | 48,344 | 4,854 | Rust |
...
| 40 | [GyulyVGC/sniffnet](https://github.com/GyulyVGC/sniffnet)<br><sub>Comfortably monitor your network traffic 🕵️‍♂️</sub> | 41,204 | 1,962 | Rust |
| 41 | [Hmbown/Codewhale](https://github.com/Hmbown/Codewhale)<br><sub>Open-source coding agent for your terminal, built in Rust and on a journey of continuous community improvement. Issue...</sub> | 41,030 | 3,563 | Rust |
| 42 | [nushell/nushell](https://github.com/nushell/nushell)<br><sub>A new type of shell</sub> | 40,556 | 2,268 | Rust |
| 43 | [herdrdev/herdr](https://github.com/herdrdev/herdr)<br><sub>the runtime your coding agents live on</sub> | 40,376 | 3,076 | Rust |
| 44 | [tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman)<br><sub>OpenHuman is an open source agent harness with local-first memory, agent orchestration, and workflows</sub> | 40,059 | 3,953 | Rust |
| 45 | [pola-rs/polars](https://github.com/pola-rs/polars)<br><sub>Extremely fast Query Engine for DataFrames, written in Rust</sub> | 39,848 | 3,127 | Rust |
| 46 | [ajeetdsouza/zoxide](https://github.com/ajeetdsouza/zoxide)<br><sub>A smarter cd command. Supports all major shells.</sub> | 39,660 | 908 | Rust |
| 47 | [DioxusLabs/dioxus](https://github.com/DioxusLabs/dioxus)<br><sub>Fullstack app framework for web, desktop, and mobile.</sub> | 39,220 | 1,900 | Rust |
| 48 | [spacedriveapp/spacedrive](https://github.com/spacedriveapp/spacedrive)<br><sub>Spacedrive is an open source cross-platform file explorer, powered by a virtual distributed filesystem written in Rust.</sub> | 39,020 | 1,353 | Rust |
| 49 | [lapce/lapce](https://github.com/lapce/lapce)<br><sub>Lightning-fast and Powerful Code Editor written in Rust</sub> | 38,863 | 1,335 | Rust |
| 50 | [servo/servo](https://github.com/servo/servo)<br><sub>Servo aims to empower developers with a lightweight, high-performance alternative for embedding web technologies in a...</sub> | 38,027 | 3,806 | Rust |
| 51 | [AlexsJones/llmfit](https://github.com/AlexsJones/llmfit)<br><sub>Hundreds of models & providers. One command to find what runs on your hardware.</sub> | 37,069 | 2,364 | Rust |
| 52 | [firecracker-microvm/firecracker](https://github.com/firecracker-microvm/firecracker)<br><sub>Secure and fast microVMs for serverless computing.</sub> | 36,898 | 2,643 | Rust |
| 53 | [pnpm/pnpm](https://github.com/pnpm/pnpm)<br><sub>Fast, disk space efficient package manager</sub> | 36,622 | 1,752 | Rust |
| 54 | [casey/just](https://github.com/casey/just)<br><sub>🤖 Just a command runner</sub> | 35,977 | 847 | Rust |
| 55 | [zellij-org/zellij](https://github.com/zellij-org/zellij)<br><sub>A terminal workspace with batteries included</sub> | 35,513 | 1,461 | Rust |
| 56 | [qdrant/qdrant](https://github.com/qdrant/qdrant)<br><sub>Qdrant - High-performance, massive-scale Vector Database and Vector Search Engine for the next generation of AI. Also...</sub> | 34,760 | 2,691 | Rust |
...
| 64 | [google/comprehensive-rust](https://github.com/google/comprehensive-rust)<br><sub>This is the Rust course used by the Android team at Google. It provides you the material to quickly teach Rust.</sub> | 33,376 | 2,072 | Rust |
| 65 | [tokio-rs/tokio](https://github.com/tokio-rs/tokio)<br><sub>A runtime for writing reliable asynchronous applications with Rust. Provides I/O, networking, scheduling, timers, ...</sub> | 33,213 | 3,727 | Rust |
| 66 | [surrealdb/surrealdb](https://github.com/surrealdb/surrealdb)<br><sub>A scalable, distributed, collaborative, document-graph database, for the realtime web</sub> | 33,055 | 1,362 | Rust |
| 67 | [zeroclaw-labs/zeroclaw](https://github.com/zeroclaw-labs/zeroclaw)<br><sub>Fast, small, and fully autonomous AI personal assistant infrastructure, any OS, any platform — deploy anywhere, swap...</sub> | 32,875 | 4,951 | Rust |
| 68 | [yewstack/yew](https://github.com/yewstack/yew)<br><sub>Rust / Wasm framework for creating reliable and efficient web applications</sub> | 32,816 | 1,453 | Rust |
| 69 | [dandavison/delta](https://github.com/dandavison/delta)<br><sub>A syntax-highlighting pager for git, diff, grep, rg --json, and blame output</sub> | 32,313 | 580 | Rust |
| 70 | [linera-io/linera-protocol](https://github.com/linera-io/linera-protocol)<br><sub>Main repository for the Linera protocol</sub> | 32,119 | 2,417 | Rust |
| 71 | [cjpais/Handy](https://github.com/cjpais/Handy)<br><sub>A free, open source, and extensible speech-to-text application that works completely offline.</sub> | 32,079 | 2,938 | Rust |
| 72 | [atuinsh/atuin](https://github.com/atuinsh/atuin)<br><sub>✨ Making your shell magical</sub> | 31,788 | 971 | Rust |
| 73 | [influxdata/influxdb](https://github.com/influxdata/influxdb)<br><sub>Scalable datastore for metrics, events, and real-time analytics</sub> | 31,753 | 3,717 | Rust |
...
| 86 | [wezterm/wezterm](https://github.com/wezterm/wezterm)<br><sub>A GPU-accelerated cross-platform terminal emulator and multiplexer written by @wez and implemented in Rust</sub> | 29,002 | 1,754 | Rust |
| 87 | [sharkdp/hyperfine](https://github.com/sharkdp/hyperfine)<br><sub>A command-line benchmarking tool</sub> | 28,892 | 512 | Rust |
| 88 | [BloopAI/vibe-kanban](https://github.com/BloopAI/vibe-kanban)<br><sub>Get 10X more out of Claude Code, Codex or any coding agent</sub> | 28,172 | 3,020 | Rust |
| 89 | [niri-wm/niri](https://github.com/niri-wm/niri)<br><sub>A scrollable-tiling Wayland compositor.</sub> | 27,924 | 1,156 | Rust |
| 90 | [h4ckf0r0day/obscura](https://github.com/h4ckf0r0day/obscura)<br><sub>The headless browser for AI agents and web scraping</sub> | 27,774 | 2,047 | Rust |
| 91 | [cloudflare/pingora](https://github.com/cloudflare/pingora)<br><sub>A library for building fast, reliable and evolvable network services.</sub> | 27,516 | 1,756 | Rust |
| 92 | [GraphiteEditor/Graphite](https://github.com/GraphiteEditor/Graphite)<br><sub>Community-built comprehensive 2D content creation appplication for graphic design, digital art, and interactive real-...</sub> | 27,339 | 1,263 | Rust |
| 93 | [tokio-rs/axum](https://github.com/tokio-rs/axum)<br><sub>HTTP routing and request-handling library for Rust that focuses on ergonomics and modularity</sub> | 27,218 | 1,487 | Rust |
| 94 | [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts)<br><sub>Switch hosts quickly!</sub> | 27,217 | 2,683 | Rust |
| 95 | [xai-org/grok-build](https://github.com/xai-org/grok-build)<br><sub>SpaceXAI's coding agent harness and TUI. Fullscreen, mouse interactive, extensible.</sub> | 27,047 | 5,097 | Rust |
| 96 | [tree-sitter/tree-sitter](https://github.com/tree-sitter/tree-sitter)<br><sub>An incremental parsing system for programming tools</sub> | 27,025 | 2,913 | Rust |
| 97 | [Schniz/fnm](https://github.com/Schniz/fnm)<br><sub>🚀 Fast and simple Node.js version manager, built in Rust</sub> | 26,940 | 648 | Rust |
| 98 | [TheAlgorithms/Rust](https://github.com/TheAlgorithms/Rust)<br><sub>All Algorithms implemented in Rust</sub> | 26,064 | 2,598 | Rust |
| 99 | [Wilfred/difftastic](https://github.com/Wilfred/difftastic)<br><sub>a structural diff that understands syntax 🟥🟩</sub> | 25,923 | 519 | Rust |
| 100 | [biomejs/biome](https://github.com/biomejs/biome)<br><sub>A toolchain for web projects, aimed to provide functionalities to maintain them. Biome offers formatter and linter, u...</sub> | 25,848 | 1,237 | Rust |
